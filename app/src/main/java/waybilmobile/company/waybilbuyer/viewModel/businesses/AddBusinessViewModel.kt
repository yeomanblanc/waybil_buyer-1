package waybilmobile.company.waybilbuyer.viewModel.businesses
...
class AddBusinessViewModel : ViewModel() {
    ...
    fun submitNewBusiness(businessName: String, businessAddress: String, businessType: String,
        businessLocation: GeoPoint, businessPhone: String){
        ...
        businessType, businessLocation, businessPhone)
